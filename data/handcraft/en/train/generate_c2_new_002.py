"""Generate 200 handcrafted English C2 CoNLL-U sentences (en_c2_train_201–400)."""
...
START_ID = 201
BATCH_SIZE = 25
TARGET_PATH = project_root / "data/handcraft/en/train/c2_new_002.conllu"
...
def main() -> None:
    ...
    print("Sent_ids: en_c2_train_201 – en_c2_train_400")
    print("Status: OK")
