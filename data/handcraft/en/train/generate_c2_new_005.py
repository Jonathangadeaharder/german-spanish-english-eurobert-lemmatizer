"""Generate 100 handcrafted English C2 CoNLL-U sentences (en_c2_train_801–900)."""
...
START_ID = 801
BATCH_SIZE = 25
TARGET_PATH = project_root / "data/handcraft/en/train/c2_new_005.conllu"
...
SPECIAL_LEMMAS: dict[str, tuple[str, str]] = {
    ...
    "Geertz's": ("Geertz", "PROPN"),
    "Geertz": ("Geertz", "PROPN"),
    "Mauss": ("Mauss", "PROPN"),
    "Malinowskian": ("Malinowskian", "ADJ"),
    "Westphalian": ("Westphalian", "ADJ"),
    "Leopold": ("Leopold", "PROPN"),
    "principlism": ("principlism", "NOUN"),
    "solastalgia": ("solastalgia", "NOUN"),
    "betwixt-and-between": ("betwixt-and-between", "ADJ"),
    "gray-zone": ("gray-zone", "ADJ"),
    "face-to-face": ("face-to-face", "ADJ"),
    "more-than-human": ("more-than-human", "ADJ"),
    "co-evolve": ("co-evolve", "VERB"),
    "co-produced": ("co-produced", "ADJ"),
    "ethnography's": ("ethnography", "NOUN"),
    "patients'": ("patient", "NOUN"),
    "personhood": ("personhood", "NOUN"),
    "petrocultures": ("petroculture", "NOUN"),
    "nonmaleficence": ("nonmaleficence", "NOUN"),
    "Anthropocene": ("Anthropocene", "PROPN"),
}
...
def main() -> None:
    ...
    print("Sent_ids: en_c2_train_801 – en_c2_train_900")
    print("Status: OK")
