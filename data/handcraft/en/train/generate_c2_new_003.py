"""Generate 200 handcrafted English C2 CoNLL-U sentences (en_c2_train_401–600)."""
...
START_ID = 401
BATCH_SIZE = 25
TARGET_PATH = project_root / "data/handcraft/en/train/c2_new_003.conllu"
...
def main() -> None:
    ...
    print("Sent_ids: en_c2_train_401 – en_c2_train_600")
    print("Status: OK")
