"""Generate b2_new_002.conllu (es_b2_train_201–400) with Stanza + validation."""
...
from b2_new_002_sentences import SENTENCE_BATCHES, SENTENCES
...
def main() -> None:
    ...
    target_path = project_root / "data/handcraft/es/train/b2_new_002.conllu"
