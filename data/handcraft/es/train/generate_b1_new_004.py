"""Generate b1_new_004.conllu (es_b1_train_601–800) with Stanza + validation."""
...
from b1_new_004_sentences import SENTENCE_BATCHES, SENTENCES  # noqa: E402
...
def main() -> None:
    ...
    target_path = project_root / "data/handcraft/es/train/b1_new_004.conllu"
