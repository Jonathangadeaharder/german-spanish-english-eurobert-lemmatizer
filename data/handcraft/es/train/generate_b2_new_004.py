"""Generate b2_new_004.conllu (es_b2_train_601–800) with Stanza + validation."""
...
from b2_new_004_sentences import SENTENCE_BATCHES, SENTENCES
...
def main() -> None:
    ...
    target_path = project_root / "data/handcraft/es/train/b2_new_004.conllu"
