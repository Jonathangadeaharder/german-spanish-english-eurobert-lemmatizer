"""Generate a2_new_005.conllu — es_a2_train_801 through es_a2_train_900."""
...
# 4 batches × 25 = 100 sentences
sys.path.insert(0, str(Path(__file__).resolve().parent))
from a2_new_005_sentences import SENTENCE_BATCHES, SENTENCES  # noqa: E402
...
def main() -> None:
    ...
    target_path = project_root / "data/handcraft/es/train/a2_new_005.conllu"
    ...
    print("STATUS: OK — 100 sentences, es_a2_train_801–es_a2_train_900")
