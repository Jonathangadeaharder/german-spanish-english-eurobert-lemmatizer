"""Generate b2_new_005.conllu (es_b2_train_801–900) with Stanza + validation."""
...
from b2_new_005_sentences import SENTENCE_BATCHES, SENTENCES
...
def main() -> None:
    ...
    target_path = project_root / "data/handcraft/es/train/b2_new_005.conllu"
