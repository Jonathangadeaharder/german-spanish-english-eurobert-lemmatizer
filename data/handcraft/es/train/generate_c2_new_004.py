"""Generate 200 handcrafted Spanish C2 CoNLL-U sentences (es_c2_train_601–800)."""
...
START_ID = 601
TARGET_PATH = project_root / "data/handcraft/es/train/c2_new_004.conllu"
...
ES_DET_LEMMAS: dict[str, str] = {
    ...
    "su": "su", "sus": "su", "mi": "mi", "mis": "mi", "tu": "tu", "tus": "tu",
...
SPECIAL_LEMMAS: dict[str, tuple[str, str]] = {
    ...
    "Aristóteles": ("Aristóteles", "PROPN"),
    "Grice": ("Grice", "PROPN"),
    "Labov": ("Labov", "PROPN"),
    "Adorno": ("Adorno", "PROPN"),
    "Beauchamp": ("Beauchamp", "PROPN"),
    "Childress": ("Childress", "PROPN"),
    "Schenker": ("Schenker", "PROPN"),
    "Wagner": ("Wagner", "PROPN"),
    "Ginebra": ("Ginebra", "PROPN"),
    "Sapir-Whorf": ("Sapir-Whorf", "PROPN"),
    "Sapir": ("Sapir", "PROPN"),
    "Whorf": ("Whorf", "PROPN"),
    "Roma": ("Roma", "PROPN"),
    "posteriori": ("posteriori", "X"),
    "uso-mención": ("uso-mención", "NOUN"),
    "sentido-referencia": ("sentido-referencia", "NOUN"),
    "núcleo-periferia": ("núcleo-periferia", "NOUN"),
    "cities": ("cities", "NOUN"),
    "Cities": ("Cities", "NOUN"),
    "trap": ("Trap", "PROPN"),
    "Trap": ("Trap", "PROPN"),
...
VERB_OVERRIDES: dict[str, str] = {
    "cuestionada": "cuestionar",
    "cuestionado": "cuestionar",
    "descifrado": "descifrar",
    "disfrute": "disfrutar",
    "desplazadas": "desplazar",
    "desplazado": "desplazar",
    "desplazados": "desplazar",
    "es": "ser",
    "son": "ser",
    "era": "ser",
    "eran": "ser",
...
PARTICIPLE_ADJ: dict[str, str] = {
    "controvertido": "controvertido",
    "controvertida": "controvertido",
    "controvertidos": "controvertido",
    "controvertidas": "controvertido",
    "obligado": "obligado",
    "obligada": "obligado",
    "obligados": "obligado",
    "obligadas": "obligado",
    "desproporcionada": "desproporcionado",
    "desproporcionado": "desproporcionado",
    "desproporcionados": "desproporcionado",
    "desproporcionadas": "desproporcionado",
}
...
def normalize_token(form: str, upos: str, lemma: str) -> tuple[str, str]:
    ...
    if low in SPECIAL_LEMMAS:
        return SPECIAL_LEMMAS[low]
    ...
    if low in PARTICIPLE_ADJ and upos == "VERB":
        return PARTICIPLE_ADJ[low], "ADJ"
...
def build_conllu(sentences: list[str], start_id: int, nlp) -> str:
    ...
    if token_warnings:
        ...
        for w in token_warnings:
            print(f"  {w}")
        raise ValueError(f"{len(token_warnings)} sentences outside 15-28 token range")
...
def main() -> None:
    ...
    print("Sent_ids: es_c2_train_601 – es_c2_train_800")
    print("Status: OK")
