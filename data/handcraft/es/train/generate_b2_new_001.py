"""Generate b2_new_001.conllu (es_b2_train_001–200) with Stanza + validation."""
...
from b2_new_001_sentences import SENTENCE_BATCHES, SENTENCES
...
# Past participles where Stanza lemma ≠ infinitive
...
def main() -> None:
    ...
    target_path = project_root / "data/handcraft/es/train/b2_new_001.conllu"
