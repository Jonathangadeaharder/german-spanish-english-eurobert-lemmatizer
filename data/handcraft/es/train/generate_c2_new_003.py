"""Generate 200 handcrafted Spanish C2 CoNLL-U sentences (es_c2_train_401–600)."""
...
from c2_new_003_sentences import BATCHES, SENTENCES
...
START_ID = 401
TARGET_PATH = project_root / "data/handcraft/es/train/c2_new_003.conllu"
...
def main() -> None:
    ...
    print("Sent_ids: es_c2_train_401 – es_c2_train_600")
    print("Status: OK")
