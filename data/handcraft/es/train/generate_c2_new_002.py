"""Generate 200 handcrafted Spanish C2 CoNLL-U sentences (es_c2_train_201–400)."""
...
from c2_new_002_sentences import BATCHES, SENTENCES
...
START_ID = 201
TARGET_PATH = project_root / "data/handcraft/es/train/c2_new_002.conllu"
...
def main() -> None:
    ...
    print("Sent_ids: es_c2_train_201 – es_c2_train_400")
    print("Status: OK")
