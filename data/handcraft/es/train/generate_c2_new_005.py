"""Generate 100 handcrafted Spanish C2 CoNLL-U sentences (es_c2_train_801–900)."""
...
from c2_new_005_sentences import BATCHES, SENTENCES
...
START_ID = 801
TARGET_PATH = project_root / "data/handcraft/es/train/c2_new_005.conllu"
...
def main() -> None:
    ...
    for batch_num, batch in enumerate(BATCHES, 1):
        print(f"  Batch {batch_num}/4 ({len(batch)} sentences)...")
    ...
    print("Sent_ids: es_c2_train_801 – es_c2_train_900")
    print("Status: OK")
