"""Generate 200 handcrafted Spanish C1 CoNLL-U sentences (es_c1_train_401–600)."""
...
from c1_new_003_sentences import SENTENCE_BATCHES, SENTENCES  # noqa: E402

START_ID = 401
BATCH_SIZE = 25
TARGET_PATH = project_root / "data/handcraft/es/train/c1_new_003.conllu"
...
def normalize_token(form: str, upos: str, lemma: str) -> tuple[str, str]:
    ...
    if upos == "VERB":
        ...
        elif low in VERB_OVERRIDES:
            lem = VERB_OVERRIDES[low]
        participle = _participle_to_infinitive(lem)
...
def main() -> None:
    ...
    print("STATUS: OK — es_c1_train_401 through es_c1_train_600")
